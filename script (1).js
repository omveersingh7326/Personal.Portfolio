...
fetch(url).then((response) => {
    ...
    if (weatherCondition.includes("clear")) {
        body.style.backgroundImage = "url('img/clear-sky.jpg')"; // Replace with appropriate image URL
    } else if (weatherCondition.includes("cloud")) {
        body.style.backgroundImage = "url('img/cloudy.jpg')"; // Replace with appropriate image URL
    } else if (weatherCondition.includes("rain")) {
        body.style.backgroundImage = "url('img/rainy.jpg')"; // Replace with appropriate image URL
    } else if (weatherCondition.includes("haze")) {
        body.style.backgroundImage = "url('img/haze.jpg')"; // Replace with appropriate image URL
    } else {
        // Default background for other conditions
        body.style.backgroundImage = "url('img/default.jpg')"; // Replace with appropriate image URL
    }
...
const city = 'Nagpur'; // Replace with the desired city name
const country = 'IN'; // Replace with the desired country code
const startDay = '2023-08-25'; // Replace this with the desired start day in YYYY-MM-DD format
